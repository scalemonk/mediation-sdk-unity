...
$unityPath'/Unity.app/Contents/MacOS/Unity' -runTests -batchmode -projectPath . -testResults ./test-results.xml -enableCodeCoverage -coverageOptions 'enableCyclomaticComplexity;generateHtmlReport;generateBadgeReport;assemblyFilters:+ScaleMonk.*,-UnityEditor*' -coverageResultsPath ./CodeCoverage
